...
- **카테고리:** 아동학대/가정폭력, 노동, 금융, 성폭력, 온라인폭력, 출생/양육, 법정대리인
...
- 사용자가 자신의 상황을 입력하면 AI가 법률 매뉴얼 DB를 기반으로 상황을 요약하고 관련 콘텐츠(매뉴얼, QnA) 안내
- OpenAI GPT-4o-mini 기반 2단계 진단 (상황 분류 → 법률 안내 생성)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>AI</td>
      <td>
        <img src="https://img.shields.io/badge/OpenAI_GPT--4o--mini-412991?style=flat&logo=openai&logoColor=white"/>
      </td>
    </tr>
    <tr>
      <td>인프라</td>
